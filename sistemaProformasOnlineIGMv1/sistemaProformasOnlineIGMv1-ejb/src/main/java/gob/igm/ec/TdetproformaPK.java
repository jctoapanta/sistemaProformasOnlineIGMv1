...
public class TdetproformaPK implements Serializable {
    ...
    public TdetproformaPK(short idPeriodo, long idSucursal, long idProforma, short noReg) {
    ...
    public String toString() {
        return "gob.igm.ec.TdetproformaPK[ idPeriodo=" + idPeriodo + ", idSucursal=" + idSucursal + ", idProforma=" + idProforma + ", noReg=" + noReg + " ]";
    }
