...
<f:view>
    <html>
        <head>
            ...
            <title>TNacionalidad Detail</title>
        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{tNacionalidad.TNacionalidad.nacionalidad}" title="Nacionalidad" />

                    <h:outputText value="TDatEmpleadoList:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty tNacionalidad.TNacionalidad.TDatEmpleadoList}" value="(No Items)"/>
                        <h:dataTable value="#{tNacionalidad.TNacionalidad.TDatEmpleadoList}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty tNacionalidad.TNacionalidad.TDatEmpleadoList}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{tDatEmpleado.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="tNacionalidad" />
                                    <f:param name="jsfcrud.relatedControllerType" value="rh.gob.igm.ec.controladores.TNacionalidadController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{TNacionalidad.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentTNacionalidad" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tNacionalidad.TNacionalidad][tNacionalidad.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{TNacionalidad.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentTNacionalidad" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tNacionalidad.TNacionalidad][tNacionalidad.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <h:commandLink action="#{TNacionalidad.createSetup}" value="New TNacionalidad" />
                <br />
                <h:commandLink action="#{TNacionalidad.listSetup}" value="Show All TNacionalidad Items"/>
                <br />
                <br />
