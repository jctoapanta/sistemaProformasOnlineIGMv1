...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New TDatEmpleado</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{tDatEmpleado.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="NoPersona:"/>
                    <h:inputText id="noPersona" value="#{tDatEmpleado.TDatEmpleado.noPersona}" title="NoPersona" required="true" requiredMessage="The noPersona field is required." />
                ...
                <br />
                <h:commandLink action="#{tDatEmpleado.create}" value="Create"/>
                <br />
                <br />
