...
<f:view>
    <html>
        <head>
            ...
            <title>Listing TDatEmpleado Items</title>
        ...
        <body>
            ...
            <h1>Listing TDatEmpleado Items</h1>
            <h:form styleClass="jsfcrud_list_form">
                <h:outputText escape="false" value="(No TDatEmpleado Items Found)<br />" rendered="#{tDatEmpleado.pagingInfo.itemCount == 0}" />
                <h:panelGroup rendered="#{tDatEmpleado.pagingInfo.itemCount > 0}">
                    <h:outputText value="Item #{tDatEmpleado.pagingInfo.firstItem + 1}..#{tDatEmpleado.pagingInfo.lastItem} of #{tDatEmpleado.pagingInfo.itemCount}"/>&nbsp;
                    <h:commandLink action="#{tDatEmpleado.prev}" value="Previous #{tDatEmpleado.pagingInfo.batchSize}" rendered="#{tDatEmpleado.pagingInfo.firstItem >= tDatEmpleado.pagingInfo.batchSize}"/>&nbsp;
                    <h:commandLink action="#{tDatEmpleado.next}" value="Next #{tDatEmpleado.pagingInfo.batchSize}" rendered="#{tDatEmpleado.pagingInfo.lastItem + tDatEmpleado.pagingInfo.batchSize <= tDatEmpleado.pagingInfo.itemCount}"/>&nbsp;
                    <h:commandLink action="#{tDatEmpleado.next}" value="Remaining #{tDatEmpleado.pagingInfo.itemCount - tDatEmpleado.pagingInfo.lastItem}"
                                   rendered="#{tDatEmpleado.pagingInfo.lastItem < tDatEmpleado.pagingInfo.itemCount && tDatEmpleado.pagingInfo.lastItem + tDatEmpleado.pagingInfo.batchSize > tDatEmpleado.pagingInfo.itemCount}"/>
                    <h:dataTable value="#{tDatEmpleado.TDatEmpleadoItems}" var="item" border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px">
                        <h:column>
                            <f:facet name="header">
                        ...
                        <h:column>
                            ...
                            <h:outputText value=" "/>
                            <h:commandLink value="Destroy" action="#{tDatEmpleado.remove}">
                                <f:param name="jsfcrud.currentTDatEmpleado" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][item][tDatEmpleado.converter].jsfcrud_invoke}"/>
                            </h:commandLink>
                        </h:column>
