        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{tLicencia.TLicencia.descrip}" title="Descrip" />
                    <h:outputText value="Obs:"/>
                    <h:outputText value="#{tLicencia.TLicencia.obs}" title="Obs" />

                    <h:outputText value="TDatEmpleadoList:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty tLicencia.TLicencia.TDatEmpleadoList}" value="(No Items)"/>
                        <h:dataTable value="#{tLicencia.TLicencia.TDatEmpleadoList}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty tLicencia.TLicencia.TDatEmpleadoList}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{tDatEmpleado.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="tLicencia" />
                                    <f:param name="jsfcrud.relatedControllerType" value="rh.gob.igm.ec.controladores.TLicenciaController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{TLicencia.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentTLicencia" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tLicencia.TLicencia][tLicencia.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{TLicencia.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentTLicencia" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tLicencia.TLicencia][tLicencia.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <h:commandLink action="#{TLicencia.createSetup}" value="New TLicencia" />
                <br />
                <h:commandLink action="#{TLicencia.listSetup}" value="Show All TLicencia Items"/>
                <br />
                <br />
