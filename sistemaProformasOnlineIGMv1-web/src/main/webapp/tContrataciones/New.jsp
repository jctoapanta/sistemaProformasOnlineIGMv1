...
<f:view>
    <html>
        <head>
            ...
            <title>New TContrataciones</title>
        ...
        <body>
            ...
            <h1>New TContrataciones</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{tContrataciones.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="NoCont:"/>
                    <h:inputText id="noCont" value="#{tContrataciones.TContrataciones.TContratacionesPK.noCont}" title="NoCont" required="true" requiredMessage="The noCont field is required." />
                    ...
                    <h:selectOneMenu id="TDatEmpleado" value="#{tContrataciones.TContrataciones.TDatEmpleado}" title="TDatEmpleado" required="true" requiredMessage="The TDatEmpleado field is required." >
                        <f:selectItems value="#{TDatEmpleado.TDatEmpleadoItemsAvailableSelectOne}"/>
                    </h:selectOneMenu>
                ...
                <br />
                <h:commandLink action="#{tContrataciones.create}" value="Create"/>
                <br />
                <br />
