...
<f:view>
    <html>
        <head>
            ...
            <title>TProfesiones Detail</title>
        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{tProfesiones.TProfesiones.descrip}" title="Descrip" />
                    <h:outputText value="Abrev:"/>
                    <h:outputText value="#{tProfesiones.TProfesiones.abrev}" title="Abrev" />
                    <h:outputText value="Codigo:"/>
                    <h:outputText value="#{tProfesiones.TProfesiones.codigo}" title="Codigo" />

                    <h:outputText value="TDatEmpleadoList:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty tProfesiones.TProfesiones.TDatEmpleadoList}" value="(No Items)"/>
                        <h:dataTable value="#{tProfesiones.TProfesiones.TDatEmpleadoList}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty tProfesiones.TProfesiones.TDatEmpleadoList}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{tDatEmpleado.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="tProfesiones" />
                                    <f:param name="jsfcrud.relatedControllerType" value="rh.gob.igm.ec.controladores.TProfesionesController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{TProfesiones.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentTProfesiones" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tProfesiones.TProfesiones][tProfesiones.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{TProfesiones.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentTProfesiones" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tProfesiones.TProfesiones][tProfesiones.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <h:commandLink action="#{TProfesiones.createSetup}" value="New TProfesiones" />
                <br />
                <h:commandLink action="#{TProfesiones.listSetup}" value="Show All TProfesiones Items"/>
                <br />
                <br />
