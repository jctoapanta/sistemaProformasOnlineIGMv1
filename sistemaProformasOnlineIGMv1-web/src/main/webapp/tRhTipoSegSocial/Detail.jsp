...
<f:view>
    <html>
        <head>
            ...
            <title>TRhTipoSegSocial Detail</title>
        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{tRhTipoSegSocial.TRhTipoSegSocial.descrip}" title="Descrip" />
                    <h:outputText value="Codigo:"/>
                    <h:outputText value="#{tRhTipoSegSocial.TRhTipoSegSocial.codigo}" title="Codigo" />

                    <h:outputText value="TDatEmpleadoList:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty tRhTipoSegSocial.TRhTipoSegSocial.TDatEmpleadoList}" value="(No Items)"/>
                        <h:dataTable value="#{tRhTipoSegSocial.TRhTipoSegSocial.TDatEmpleadoList}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty tRhTipoSegSocial.TRhTipoSegSocial.TDatEmpleadoList}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{tDatEmpleado.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="tRhTipoSegSocial" />
                                    <f:param name="jsfcrud.relatedControllerType" value="rh.gob.igm.ec.controladores.TRhTipoSegSocialController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{TRhTipoSegSocial.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentTRhTipoSegSocial" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tRhTipoSegSocial.TRhTipoSegSocial][tRhTipoSegSocial.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{TRhTipoSegSocial.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentTRhTipoSegSocial" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tRhTipoSegSocial.TRhTipoSegSocial][tRhTipoSegSocial.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <h:commandLink action="#{TRhTipoSegSocial.createSetup}" value="New TRhTipoSegSocial" />
                <br />
                <h:commandLink action="#{TRhTipoSegSocial.listSetup}" value="Show All TRhTipoSegSocial Items"/>
                <br />
                <br />
