...
<f:view>
    <html>
        <head>
            ...
            <title>TTiposContrato Detail</title>
        ...
        <body>
            ...
            <h:form>
                <h:panelGrid columns="2">
                    ...
                    <h:outputText value="#{tTiposContrato.TTiposContrato.descrip}" title="Descrip" />
                    <h:outputText value="LDuracion:"/>
                    <h:outputText value="#{tTiposContrato.TTiposContrato.LDuracion}" title="LDuracion" />
                    <h:outputText value="TTiempo:"/>
                    <h:outputText value="#{tTiposContrato.TTiposContrato.TTiempo}" title="TTiempo" />
                    <h:outputText value="Duracion:"/>
                    <h:outputText value="#{tTiposContrato.TTiposContrato.duracion}" title="Duracion" />
                    <h:outputText value="LValido:"/>
                    <h:outputText value="#{tTiposContrato.TTiposContrato.LValido}" title="LValido" />

                    <h:outputText value="TContratacionesList:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty tTiposContrato.TTiposContrato.TContratacionesList}" value="(No Items)"/>
                        <h:dataTable value="#{tTiposContrato.TTiposContrato.TContratacionesList}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty tTiposContrato.TTiposContrato.TContratacionesList}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{tContrataciones.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="tTiposContrato" />
                                    <f:param name="jsfcrud.relatedControllerType" value="rh.gob.igm.ec.controladores.TTiposContratoController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{TTiposContrato.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentTTiposContrato" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tTiposContrato.TTiposContrato][tTiposContrato.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{TTiposContrato.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentTTiposContrato" value="#{jsfcrud_class['rh.gob.igm.ec.controladores.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tTiposContrato.TTiposContrato][tTiposContrato.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <h:commandLink action="#{TTiposContrato.createSetup}" value="New TTiposContrato" />
                <br />
                <h:commandLink action="#{TTiposContrato.listSetup}" value="Show All TTiposContrato Items"/>
                <br />
                <br />
